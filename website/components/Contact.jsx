    ...
    <section id="contact" className="bg-white py-28">
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div ref={ref} className="max-w-2xl mx-auto text-center mb-12">
          <p className={`text-[11px] font-bold uppercase tracking-widest text-violet-600 mb-3 reveal d-0 ${inView ? 'visible' : ''}`}>Contact Sales</p>
          <h2 className={`text-4xl sm:text-5xl font-extrabold text-slate-900 tracking-tight leading-[1.1] mb-4 reveal d-75 ${inView ? 'visible' : ''}`}>
            Talk to a<br /><span className="gradient-text">dental AI specialist.</span>
          </h2>
          <p className={`text-slate-400 text-base font-light reveal d-150 ${inView ? 'visible' : ''}`}>
        ...
        <div className="max-w-lg mx-auto">
          {done ? (
            <div className="g-card p-14 text-center">
              ...
              <p className="text-slate-400 text-sm">Our team will be in touch within 1 business day.</p>
            </div>
          ) : (
            <form onSubmit={submit} className="g-card p-7 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-[11px] font-bold text-slate-500 uppercase tracking-wide mb-1.5">Name</label>
              ...
              <div>
                <label className="block text-[11px] font-bold text-slate-500 uppercase tracking-wide mb-1.5">Practice</label>
              ...
              <p className="text-center text-[11px] text-slate-400">We respond within 1 business day.</p>
            </form>
          )}
        </div>
      </div>
